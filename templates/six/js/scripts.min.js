function scrollToGatewayInputError() {
    var t = jQuery(".gateway-errors,.assisted-cc-input-feedback").first(),
        e = t.closest("form");
    e || (e = jQuery("form").first()), e.find('button[type="submit"],input[type="submit"]').prop("disabled", !1).removeClass("disabled").find("i.fas,i.far,i.fal,i.fab").removeAttr("class").addClass("fas fa-arrow-circle-right").find("span").toggleClass("hidden"), t.length && jQuery("html, body").animate({
...
function hideNewCardInputFields() {
    ...
    var t = jQuery('input[name="ccinfo"]:checked'),
...
if (function(t, e) {
        ...
        function $(t, e, n, i, r) {
            for (var o, a, s, d, l, u, c, h = t.length, $ = p(e), v = [], y = 0; y < h; y++)
                ...
                if (!ct.leadingWhitespace && Wt.test(a) && v.push(e.createTextNode(Wt.exec(a)[0])), !ct.tbody)
                    for (a = "table" !== l || Gt.test(a) ? "<table>" !== c[1] || Gt.test(a) ? 0 : d : d.firstChild, o = a && a.childNodes.length; o--;) pt.nodeName(u = a.childNodes[o], "tbody") && !u.childNodes.length && a.removeChild(u);
            ...
            for (d && $.removeChild(d), ct.appendChecked || pt.grep(f(v, "input"), m), y = 0; a = v[y++];)
                ...
                for (o = 0; a = d[o++];) Bt.test(a.type || "") && n.push(a);
            return d = null, $
        }
        ...
        function _(t, e, n, i) {
            ...
            if (c && (l = $(e, t[0].ownerDocument, !1, t, i), r = l.firstChild, 1 === l.childNodes.length && (l = r), r || i)) {
                ...
                if (a)
                    for (d = s[s.length - 1].ownerDocument, pt.map(s, S), u = 0; u < a; u++) o = s[u], Bt.test(o.type || "") && !pt._data(o, "globalEval") && pt.contains(d, o) && (o.src ? pt._evalUrl && pt._evalUrl(o.src) : pt.globalEval((o.text || o.textContent || o.innerHTML || "").replace(oe, "")));
                l = r = null
            }
            return t
        }
        ...
        var vt = function(t) {
            ...
            var b, C, w, x, S, T, k, _, D, j, I, A, L, N, E, M, P, R, H, O = "sizzle" + 1 * new Date,
                F = t.document,
                Q = 0,
                B = 0,
                W = n(),
            ...
            C = e.support = {}, S = e.isXML = function(t) {
                ...
                })), (C.matchesSelector = mt.test(R = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && r(function(t) {
                        ...
                        return 1 === i && 0 === r ? function(t) {
                            ...
                            if (m) {
                                ...
                                if (f = [a ? m.firstChild : m.lastChild], a && v) {
                                    for (h = m, c = h[O] || (h[O] = {}), u = c[h.uniqueID] || (c[h.uniqueID] = {}), l = u[t] || [], p = l[0] === Q && l[1], y = p && l[2], h = p && m.childNodes[p]; h = ++p && h && h[g] || (y = p = 0) || f.pop();)
                                        if (1 === h.nodeType && ++y && h === e) {
                                            u[t] = [Q, p, y];
                                            break
                                        }
                                } else if (v && (h = e, c = h[O] || (h[O] = {}), u = c[h.uniqueID] || (c[h.uniqueID] = {}), l = u[t] || [], p = l[0] === Q && l[1], y = p), y === !1)
                                    for (;
                                        (h = ++p && h && h[g] || (y = p = 0) || f.pop()) && ((s ? h.nodeName.toLowerCase() !== $ : 1 !== h.nodeType) || !++y || (v && (c = h[O] || (h[O] = {}), u = c[h.uniqueID] || (c[h.uniqueID] = {}), u[t] = [Q, y]), h !== e)););
        ...
        pt.fn.ready = function(t) {
            ...
            if (!It)
                if (It = pt.Deferred(), "complete" === it.readyState || "loading" !== it.readyState && !it.documentElement.doScroll) t.setTimeout(pt.ready);
                ...
                stop: function(t, e, n) {
                    ...
                    return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function() {
                        ...
                        if (r) a[r] && a[r].stop && i(a[r]);
                            ...
                            for (r in a) a[r] && a[r].stop && De.test(r) && i(a[r]);
        ...
        pt.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : pt.isFunction(t) ? this.each(function(n) {
                    ...
                    var e, i, r, o;
                    if ("string" === n)
                        for (i = 0, r = pt(this), o = t.match(jt) || []; e = o[i++];) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
...
function(t) {
    function e(t, e, r) {
        var o = t[0],
            a = /er/.test(r) ? _indeterminate : /bl/.test(r) ? f : h,
            s = r == _update ? {
                checked: o[h],
                disabled: o[f],
        ...
        else e && "toggle" != r || (e || t[_callback]("ifClicked"), s ? o[_type] !== c && i(t, a) : n(t, a))
    }
    ...
    _determinate = "determinate", _indeterminate = "in" + _determinate, _update = "update", _type = "type", _click = "click", _touch = "touchbegin.i touchend.i", _add = "addClass", _remove = "removeClass", _callback = "trigger", _label = "label", _cursor = "cursor", _mobile = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent), t.fn[d] = function(o, a) {
        ...
        return $ != u && $ != c || (s = 'input[type="' + $ + '"]'), x < -50 && (x = -50), g(this), p.each(function() {
            ...
            var a, s = this,
                ...
                _ = t(_label + '[for="' + p + '"]').add(o.closest(_label)),
                D = !!m.aria,
    ...
    return this.register = function() {
        if (!recaptchaLoadComplete) {
            ...
            if (e.each(function(e, n) {
                    ...
                    window[h] = function() {
                        o && i.submit()
                    }, s.attr("data-callback", h), o ? i.on("submit", function(t) {
...
function(t, e) {
    ...
    t.prototype.tokenize = function(t) {
        ...
        return l = d.length, l ? 1 === l ? (s = d[0].field, u = c[0], function(t, n) {
            ...
            var i, r, o;
            for (i = 0; i < l; i++)
                if (o = d[i].field, r = c[i] * e(h(o, t), h(o, n))) return r;
            return 0
        } : null
...
function(t) {
    ...
    var a = jQuery("#btnResendVerificationEmail");
    jQuery(a).click(function() {
        WHMCS.http.jqClient.post("clientarea.php", {
            token: csrfToken,
            action: "resendVerificationEmail"
        }).done(function(t) {
            jQuery(a).text(jQuery(a).data("email-sent")).prop("disabled", !0)
        })
    });
    ...
    jQuery(c).find("#btnTransfer").click(function() {
        ...
        var e = (jQuery(c).find('input[name="domain"]'), jQuery("#divDynamicRecaptcha")),
...
jQuery(document).ready(function() {
    ...
    function(t) {
        ...
        function h(e, n, r) {
            ...
            var g = t.inArray("asc", a.asSorting) !== -1,
                m = t.inArray("desc", a.asSorting) !== -1;
        ...
        function gt(e) {
            ...
            w[G] = z ? v + "px" : "0px", E && (j[0].style.width = Ct(q), D[0].style.width = Ct(q), D[0].style[G] = z ? v + "px" : "0px"), A.children("colgroup").insertBefore(A.children("thead")), T.scroll(), !e.bSorted && !e.bFiltered || e._drawHold || (S.scrollTop = 0)
        }
        ...
        function $t(n) {
            ...
            if (x || !C && !u && !l && h == m(n) && h == v.length)
                for (i = 0; i < h; i++) {
                    ...
                    if (n.aoData.length)
                        for (i = 0; i < g.length; i++) o = g[i], r = s[o], t(yt(n, o)).clone(!1).append(r.sContentPadding).appendTo(_);
        ...
        var Ut, qt, zt, Gt, Vt = function(e) {
                ...
                return this.each(function() {
                    ...
                    t.inArray(!0, t.map(N, function(t, e) {
                        return E.hasClass(t)
                    })) !== -1 && (t("tbody tr", this).removeClass(N.join(" ")), j.asDestroyStripes = N.slice());
                    var M, P = [],
                        R = this.getElementsByTagName("thead");
                    if (0 !== R.length && (Q(j.aoHeader, R[0]), P = B(j)), null === g.aoColumns)
                    ...
                    if (0 === z.length && W.length > 0 && ("" !== j.oScroll.sX || "" !== j.oScroll.sY) && (z = t("<tfoot/>").appendTo(this)), 0 === z.length || 0 === z.children().length ? x.addClass(I.sNoFooter) : z.length > 0 && (j.nTFoot = z[0], Q(j.aoFooter, j.nTFoot)), g.aaData)
                        for (m = 0; m < g.aaData.length; m++) b(j, g.aaData[m]);
                    else(j.bDeferLoading || "dom" == Ft(j)) && C(j, t(j.nTBody).children("tr"));
    ...
    function() {
        ...
        function V(t, e, n, i) {
            ...
            o = new T, i && m(o, 5, e);
            t: {
                if (e = r.toString(), a = e.search(jt), 0 <= a && D(e.substring(0, a)))
                    for (var s = e.match(jt), d = s.length, l = 1; l < d; ++l)
